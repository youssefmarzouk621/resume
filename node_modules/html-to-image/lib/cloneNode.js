        ...
        return __generator(this, function (_a) {
            ...
            if (node instanceof HTMLVideoElement && node.poster) {
                return [2 /*return*/, Promise.resolve(node.poster)
                        ...
                        .then(function (data) {
                        return util_1.toDataURL(data.blob, util_1.getMimeType(node.poster) || data.contentType);
                    })
                        .then(function (dataURL) { return util_1.createImage(dataURL); })];
            }
            return [2 /*return*/, Promise.resolve(node.cloneNode(false))];
        });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, Promise.resolve(nativeNode)
                    ...
                    .then(function (clonedNode) { return cloneChildren(nativeNode, clonedNode, options); })
